...
export const LikeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M2 20h2c.55 0 1-.45 1-1v-9c0-.55-.45-1-1-1H2v11zm19.83-7.12c.11-.25.17-.52.17-.8V11c0-1.1-.9-2-2-2h-5.5l.95-4.58c.07-.33-.06-.66-.33-.88-.27-.22-.64-.26-.95-.1L10 6.87V19h8.91c.83 0 1.56-.57 1.83-1.35l2.42-6.05c.16-.4-.05-.85-.48-1.03z"/>
  </svg>
);
